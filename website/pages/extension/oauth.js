...
import { AnimationLogin } from '../../components/Lotties'
import Image from 'next/image'

function PageExtensionOAuth() {
    return (
        <div>
            <Head>
            ...
            <main className='w-full center my-20 text-center justify-center flex align-middle flex-col'>
                <Image className='m-auto' width={200} height={200} src="/logoText.png" alt="Sticky Notes Pro" />
                <AnimationLogin width={400} title="Login Successful" />
            </main>
        </div>
    )
}

export default PageExtensionOAuth
