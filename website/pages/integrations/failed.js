...
import { AnimationIntegrationFailed } from '../../components/Lotties'

function PageIntegrationFailed() {
  return (
    <div>
      <Head>
      ...
      <main className='center my-20 text-center justify-center flex align-middle flex-col'>
        <AnimationIntegrationFailed width={400} />
      </main>
    </div>
  )
}

export default PageIntegrationFailed
