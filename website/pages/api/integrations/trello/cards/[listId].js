...
async function get(req, res) {
    ...
    oauth.getProtectedResource(`https://api.trello.com/1/lists/${req.query.listId}/cards`, "GET", trelloAccessToken, trelloRefreshToken, async function (error, data, response) {
