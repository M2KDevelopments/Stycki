...
async function get(req, res) {
    ...
    oauth.getProtectedResource(`https://api.trello.com/1/boards/${req.query.boardId}/lists`, "GET", trelloAccessToken, trelloRefreshToken, async function (error, data, response) {
